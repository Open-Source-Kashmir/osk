  ...
  const featuredPrograms = [
    {
      ...
      description:
        "Work on real-world projects with leading open source organizations during summer break.",
      organization: "Google",
    ...
    },
    {
      ...
      description:
        "Get mentored by experienced developers while contributing to Linux Foundation projects.",
  ...
  const features = [
    {
      ...
      description:
        "Learn from experienced developers and industry professionals who guide you through your open source journey.",
    ...
    },
    {
      title: "Real Projects",
      description:
        "Work on meaningful projects that solve real-world problems and make a positive impact on the community.",
      icon: <FolderKanban className="text-indigo-500" size={40} />,
      bgColor: "bg-indigo-500/10",
    },
    {
      ...
      description:
        "Connect with developers worldwide and build lasting relationships in the open source ecosystem.",
    ...
    },
    {
      title: "Career Growth",
      description:
        "Gain valuable experience and skills that boost your career prospects in the tech industry.",
        ...
        <div className="max-w-[1200px] mx-auto px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-gray-600 dark:text-gray-300 max-w-2xl mx-auto leading-relaxed">
              Discover the most popular open source programs and start your
              journey today
            </p>
          </div>
