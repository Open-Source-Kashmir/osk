...
const Contributors = () => {
  ...
  return (
    <div className="pt-20">
          ...
          <div className="flex flex-col md:flex-row justify-between items-center mb-6 gap-4 flex-wrap">
            ...
            <div className="relative max-w-xs w-full md:w-auto">
              <input
                ...
                className="w-full py-3 pl-12 pr-4 border-2 border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800 text-gray-900 dark:text-white rounded-lg text-base transition-colors duration-300 focus:outline-none focus:border-blue-500 dark:focus:border-blue-400"
              />
      ...
      {/* Join CTA */}
      <section className="bg-gradient-to-r from-gray-900 to-gray-800 dark:from-gray-950 dark:to-gray-900 py-16 text-white">
        <div className="max-w-4xl mx-auto px-8 text-center">
          <div className="max-w-2xl mx-auto">
            <h2 className="text-3xl md:text-4xl font-bold mb-4">Join Our Community</h2>
            <p className="text-lg md:text-xl text-gray-300 dark:text-gray-400 mb-8 leading-relaxed">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <a href="https://github.com/Open-Source-Kashmir" className="bg-gradient-to-r from-blue-600 to-blue-800 dark:from-blue-500 dark:to-blue-700 text-white py-3 px-8 rounded-lg font-bold text-lg transition-all duration-300 hover:from-blue-800 hover:to-blue-900 dark:hover:from-blue-600 dark:hover:to-blue-800 hover:-translate-y-0.5 hover:shadow-lg hover:shadow-blue-500/30">
                Start Contributing
              </a>
              <a href="#" className="bg-white dark:bg-gray-800 text-blue-600 dark:text-blue-400 py-3 px-8 rounded-lg font-bold text-lg transition-all duration-300 hover:bg-gray-100 dark:hover:bg-gray-700 hover:-translate-y-0.5">
                Join Discord
              </a>
            </div>
          </div>
