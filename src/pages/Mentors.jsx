  ...
  const mentors = [
    {
      ...
      company: "Google",
      avatar: "https://placehold.co/150x150?text=SA",
    ...
    },
    {
      ...
      company: "Microsoft",
      avatar: "https://placehold.co/150x150?text=MT",
    ...
    },
    {
      ...
      company: "Adobe",
      avatar: "https://placehold.co/150x150?text=PS",
    ...
    },
    {
      ...
      company: "Netflix",
      avatar: "https://placehold.co/150x150?text=AK",
    ...
    },
    {
      ...
      company: "Red Hat",
      avatar: "https://placehold.co/150x150?text=FA",
    ...
    },
    {
      ...
      title: "engineering",
      company: "Adobe",
      avatar: "https://placehold.co/150x150?text=NG",
      expertise: ["React Native", "Flutter", "iOS", "Android"],
      experience: "5+ years",
      mentees: 20,
      bio: "Mobile app developer with 5+ years of experience specializing in React Native, Flutter, iOS, and Android. Passionate about helping developers build high-quality cross-platform apps and guiding them through their app development journey.",
      specialties: ["Software Development", "Web Development", "Programming"],
