...
const Mentors = () => {
  ...
  const filteredMentors = useMemo(() => {
    ...
    if (sortBy === "experience") {
      list = [...list].sort(
        (a, b) =>
          normalizedExperience(b.experience) -
          normalizedExperience(a.experience)
      );
  ...
  return (
    <div className="w-full overflow-x-hidden">
                ...
                <div className="mentor-info">
                  ...
                  <div className="flex justify-around mb-6 p-7 bg-gray-100 dark:bg-gray-800 rounded-2xl border-2 border-gray-300 dark:border-gray-700 transition-all duration-300 shadow-md shadow-gray-300/50 dark:shadow-gray-900/50 hover:bg-gray-50 dark:hover:bg-gray-700 hover:border-blue-500 dark:hover:border-blue-400 hover:scale-105 hover:shadow-lg hover:shadow-gray-300/50 dark:hover:shadow-gray-900/50">
                    <div className="flex flex-col items-center gap-2 flex-1">
                      ...
                      <span className="text-sm font-semibold text-gray-900 dark:text-gray-300 capitalize leading-tight">
                        Experience
                      </span>
                    </div>
                    <div className="flex flex-col items-center gap-2 flex-1">
                  ...
                  <div className="flex flex-wrap gap-3 justify-center mb-7">
                    ...
                    {mentor.expertise.length > 3 && (
                      <span className="bg-gray-100 dark:bg-gray-700 text-gray-900 dark:text-gray-300 py-2 px-5 rounded-2xl text-sm font-bold border-2 border-gray-300 dark:border-gray-600">
                        +{mentor.expertise.length - 3}
                      </span>
                    )}
                  </div>
      ...
      {selectedMentor && (
        <div
          className="fixed top-0 left-0 right-0 bottom-0 bg-black/75 dark:bg-black/85 flex items-center justify-center z-1000 p-8"
        ...
        >
          ...
          >
            <button
              className="absolute top-4 right-4 bg-gray-200 dark:bg-gray-700 border-none rounded-full w-10 h-10 flex items-center justify-center text-xl cursor-pointer text-gray-500 dark:text-gray-300 transition-all duration-300 hover:bg-gray-300 dark:hover:bg-gray-600 hover:text-gray-700 dark:hover:text-white"
              onClick={closeMentorModal}
            >
              ×
            </button>
            ...
            <div className="flex items-center gap-6 p-8 border-b border-gray-200 dark:border-gray-700">
              ...
              <div className="modal-info">
                ...
                <p className="text-sm text-blue-500 dark:text-blue-400 font-semibold mb-1">
              ...
              <div className="mb-8">
                ...
                <div className="flex flex-wrap gap-2">
                  {selectedMentor.expertise.map((skill, index) => (
                    <span
                      key={index}
                      className="bg-gray-100 dark:bg-gray-800 text-blue-500 dark:text-blue-400 py-1 px-3 rounded-2xl text-sm font-semibold border border-gray-300 dark:border-gray-600"
                    >
                      {skill}
                    </span>
                  ))}
              ...
              <div className="mb-8">
                ...
                <div className="flex flex-wrap gap-2">
                  {selectedMentor.specialties.map((specialty, index) => (
                    <span
                      key={index}
                      className="bg-gradient-to-br from-yellow-100 to-yellow-200 dark:from-yellow-900/30 dark:to-yellow-800/30 text-amber-800 dark:text-amber-400 py-1 px-3 rounded-2xl text-sm font-medium border border-amber-300 dark:border-amber-700"
                    >
                      {specialty}
                    </span>
                  ))}
